...
public:
    Rectangle_XY(value_type x0, value_type x1, value_type y0, value_type y1, value_type k, Material* material_pointer) :
    x0_{x0}, x1_{x1}, y0_{y0}, y1_{y1}, k_{k}, material_pointer_{material_pointer} {}
